"""Training script for ExcavatorVLA — qpos-transformer variant.

qpos injected into Transformer input during training (with dropout mask).
At inference: pure vision, zero qpos dependency.
...
def main():
    ...
    if args.output_dir is not None:
        ...
        # Default: separate output dir to avoid conflict with modulation model
        config.output_dir = "output/checkpoints_qpos_tf"
